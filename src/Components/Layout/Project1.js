        ...
        <div className='project-container d-flex align-items-center mb-5' id='ronda'>
            <div className=' row'>
                ...
                <div className='position-relative col-lg-6 col-md-12'>
                    <p className='text-start text-lg-end text-primary mb-1'>Featured Project | <span className='text-muted'>Jun 2021 - Dec 2021</span></p>
                    <p className='text-start text-lg-end text-dark fw-bold mb-1 fs-4'>Develop and Mantain Road Management System</p>
