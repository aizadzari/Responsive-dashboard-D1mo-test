            ...
            <div className=' row'>
                ...
                <div className='position-relative col-lg-6 col-md-12' style={{ zIndex: 2 }}>
                    ...
                    <div className='card-code is-left shadow rounded bg-light p-4 small' id='project1'>
                        ...
                        <div className='d-flex'><i className="ri-terminal-line me-2 text-primary fw-bold"></i><p className='text-dark font-monospace'>Designing a gallery page that can efficiently gather all the assets and images while maintaining fast page loading times.</p></div>
                        <div className='d-flex'><i className="ri-terminal-line me-2 text-primary fw-bold"></i><p className='text-dark font-monospace'>Designed a custom map that incorporates markers based on location, using the Mapbox API to search for specific locations.</p></div>
