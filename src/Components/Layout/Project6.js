            ...
            <div className='row'>
                ...
                <div className='position-relative col-lg-6 col-md-12' style={{ zIndex: 2 }}>
                    ...
                    <div className='card-code is-left shadow rounded bg-light p-4 small' id='project6'>
                        ...
                        <div className='d-flex'><i className="ri-terminal-line me-2 text-primary fw-bold"></i><p className='text-dark font-monospace'>Developed a custom feature that allows users to create their own consignment labels with ease. This feature provides users with the ability to fully customize their labels, ensuring that each one meets their specific needs.</p></div>
                        <div className='d-flex'><i className="ri-terminal-line me-2 text-primary fw-bold"></i><p className='text-dark font-monospace'>Implemented a 3rd party library to handle bulk orders and developed a custom feature to read the uploaded files. This feature allows users to upload large order files with ease and improves the efficiency of the order fulfillment process.</p></div>
                        <div className='d-flex'><i className="ri-terminal-line me-2 text-primary fw-bold"></i><p className='text-dark font-monospace'>Integrated Stripe as the payment gateway to enable a seamless payment process for customers. Users can securely complete their transactions directly on the platform.</p></div>
                        <div className='d-flex'><i className="ri-terminal-line me-2 text-primary fw-bold"></i><p className='text-dark font-monospace'>Developed a custom dashboard page that allows end-users to view their overall spending, order history, order status, and shipment status. This feature provides users with an easy-to-use interface that enables them to quickly access important information about their account.</p></div>
                    </div>
                </div>
