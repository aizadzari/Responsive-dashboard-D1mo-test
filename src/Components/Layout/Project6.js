        ...
        <div className='project-container d-flex align-items-center mb-5' id='delyva'>
            <div className='row'>
                ...
                <div className='position-relative col-lg-6 col-md-12'>
                    <p className='text-start text-lg-end text-primary mb-1'>Featured Project | <span className='text-muted'>Sep 2019 - May 2021</span></p>
                    <p className='text-start text-lg-end text-dark fw-bold fs-4'>Delyva Now</p>

                    <div className='card-code is-right shadow rounded bg-light p-4 small' id='project6'>
